...
{{% notice warning %}}
Không commit secret thật lên Git hoặc dán vào báo cáo. Mật khẩu database, JWT secret, SePay API key và số tài khoản ngân hàng bên dưới được che có chủ đích.
{{% /notice %}}
