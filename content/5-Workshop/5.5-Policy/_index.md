...
Product category must match the file type: categories in the **DOCUMENT** group accept document files, categories in the **MODEL_3D** group accept 3D model files. Mismatched uploads are rejected by the backend.
